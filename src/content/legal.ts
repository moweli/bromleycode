 ...
 * Legal pages.
 *
 * Written as finished documents against the real registered entity
 * (BROMLEYCODE LTD, 16566018) and against how this site actually behaves: no
 * analytics installed, no third-party consent SDK, no third-party fonts or
 * embeds, enquiry data stored only in order to reply.
 *
 * They have still not been reviewed by a solicitor. Two positions are worth a
 * professional eye before an enterprise contract relies on them: the limitation
 * of liability in the terms, and the retention periods in the privacy notice.
 * Both are stated definitely here rather than left open.
 */
...
const COMPANY = "BromleyCode Ltd";
const NUMBER = "16566018";
const OFFICE = "262 Bancroft Road, London E1 4BS";

export const privacyPolicy: { updated: string; intro: string[]; sections: LegalSection[] } = {
  updated: LEGAL_UPDATED,
  intro: [
    `This notice explains what personal data ${COMPANY} collects through this website, why we collect it, what we do with it, and the rights you have over it.`,
  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        "Enquiry data: the name, email address and message you submit through the contact form, plus organisation and role if you choose to give them. Those two fields are optional and marked as such.",
        ...
        "Technical data: IP address, user agent and requested URL, recorded in our hosting provider's server logs and used only to keep the site available and secure.",
    ...
    },
    {
      ...
      paragraphs: ["Under Article 6 of the UK GDPR we rely on the following:"],
      list: [
        "Replying to your enquiry: legitimate interests, Article 6(1)(f). Our interest is in responding to someone who has approached us about our services. The processing is what you would expect, it is minimal, and it is easy to object to. A legitimate interests assessment supporting this is retained and available on request.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Enquiry data reaches two categories of processor, each engaged under a written data processing agreement: the provider that hosts this site and retains its server logs, and the provider that carries our email and holds our correspondence. Current provider names are available on request and are listed in our supplier register.",
        "There is no CRM, no marketing automation platform and no analytics processor in the path. Nothing else receives your data.",
      ],
    },
    {
      heading: "5. International transfers",
      paragraphs: [
        "Personal data collected through this site is stored in the United Kingdom or the European Economic Area.",
        "Where a processor operates outside the UK, we rely on UK adequacy regulations where they apply, and otherwise on the International Data Transfer Agreement or the UK Addendum to the EU Standard Contractual Clauses, supported by a transfer risk assessment. We do not use a processor that cannot meet one of those routes.",
      ],
    },
    {
      heading: "6. How long we keep it",
      paragraphs: ["We do not keep personal data for longer than we need it."],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The controls described here are the same ones set out in the security schedule we use in client contracts, so a procurement reviewer will not find two different accounts of the same measures.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "That is worth stating precisely given what we do for a living. The retrieval and extraction systems we build for clients run inside those clients' environments, on their data, under their control, and are entirely separate from this site.",
      ],
    },
    {
...
export const cookiePolicy: { updated: string; intro: string[]; sections: LegalSection[] } = {
  ...
  sections: [
    ...
    },
    {
      heading: "Analytics",
      paragraphs: [
        "None are set. No analytics product is installed on this site.",
    ...
    },
    {
      ...
      paragraphs: ["For completeness, because their absence is unusual enough to be worth stating:"],
      list: [
...
export const termsOfUse: { updated: string; intro: string[]; sections: LegalSection[] } = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        `The content, design, code and diagrams on this site belong to ${COMPANY}, except where third-party material is used under licence.`,
        ...
        "Third-party trademarks shown on this site, including the platform marks in the technology band and the certification marks in the footer, remain the property of their owners. Platform marks indicate technologies we build on and do not imply partnership, affiliation or endorsement in either direction.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Nothing in these terms limits our liability for death or personal injury caused by negligence, for fraud or fraudulent misrepresentation, or for anything else that cannot lawfully be limited or excluded.",
        "Subject to that, we exclude liability for loss arising from reliance on the content of this site, and for indirect or consequential loss, loss of profit, loss of business, loss of goodwill or loss of data arising from your use of it.",
        "This clause governs your use of the website only. Liability under an engagement is dealt with in that engagement's contract and is not affected by anything here.",
...
export const accessibilityStatement: { updated: string; intro: string[]; sections: LegalSection[] } = {
  ...
  intro: [
    ...
    "This statement describes where the site stands, what we have tested, and what we know is not perfect. It is written to be specific rather than reassuring, because a statement that claims full conformance without evidence is worth nothing.",
  ],
  sections: [
    {
      heading: "How accessible this site is",
      paragraphs: [
        "This site is substantially conformant with WCAG 2.1 level AA. We have tested the areas below and they behave as intended.",
      ],
      list: [
        ...
        "Text meets a contrast ratio of at least 4.5:1 against its background. Text over the homepage video was measured across all six segments of the loop rather than the first frame, and the worst case is 11.5:1.",
    ...
    },
    {
      ...
      list: [
        ...
        "We have tested with keyboard, automated tooling and browser zoom. We have not yet run a structured test with screen reader users, which is the test that finds what the others miss.",
